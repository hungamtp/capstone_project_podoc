    ...
    public List<OrderDetailFactoryDto> getAllOrderDetailsForFactoryByCredentialId(String credentialId) {
        ...
        if(credential.isPresent()){
            if(credential.get().getFactory()!=null){
                ...
                List<OrderDetailFactoryDto> orderDetailFactoryDtos = orderDetailList.stream().filter(orderDetail ->orderDetail.getOrders().isPaid()==true).sorted().map(orderDetail -> OrderDetailFactoryDto.builder()
